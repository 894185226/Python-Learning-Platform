...
const uic_prov_pre = (pt, provParam, subjectFolder) => {
  if (pt == "default" || pt == "landing" || pt == "tryit" || pt == "tryitdb" || pt == "exercise" || pt == "xrcise" || pt == "video" || pt == "explainer" || pt == "practice" || pt == "challenge" || pt == "tut_xrcise" || pt == "tut_xrcise_fixed") { pageType = pt; }
  ...
  if (!_uic_u_ok()) {
    if (pageType != "landing") {
      if (provider == "sparteo") {
        ...
        if (pageType == "default" || pageType == "challenge" || pageType == "tut_xrcise" || pageType == "tut_xrcise_fixed") {
...
const uic_prov_sec = () => {
  if (!_uic_u_ok()) {
    if (provider == "sparteo" && (pageType == "default" || pageType == "video" || pageType == "challenge" || pageType == "tut_xrcise" || pageType == "tut_xrcise_fixed")) {
      window.addEventListener("scroll", fix_stickyad);
      window.addEventListener("resize", fix_stickyad);
    } else {
      if (pageType == "default" || pageType == "video" || pageType == "challenge" || pageType == "tut_xrcise" || pageType == "tut_xrcise_fixed") {
